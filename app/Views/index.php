<div class="container">
  ...
  <div class="grid">
    <?php foreach ($programs as $index => $p): ?>
      ...
      <!-- (1) 네 번째 카드 뒤에 광고 삽입 -->
<?php if ($index === 3): ?>                 <!-- 4번째 아이템 자리 -->
  <div class="card ad-card"
       style="animation-delay: <?= ($index + 1) * 0.1 ?>s; min-height:250px;" role="region" aria-label="광고">
    <ins class="adsbygoogle"
         style="display:block"
         data-ad-client="ca-pub-7090845684640158"
         data-ad-slot="6875729027"              <!-- 방금 만든 슬롯 ID -->
         data-ad-format="auto"
